...
module.exports = {
  ...
  run: async (client, interaction, args) => {
    ...
    if (channelData) {
      ...
      if (!Channel) return Error(interaction, "Suggestion Channel is not set")
      ...
      const Embed = new MessageEmbed()
        ...
        .addFields([
          { name: "<:icons_bulb:1018201993979891793> Suggestion", value: `${suggestion}`, inline: false },
          { name: "<:icons_edit:1018200253096280074> Suggested By", value: `${user}`, inline: true },
          { name: "Status", value: "<a:loading:1018081613210464337> Pending", inline: true },
        ])
