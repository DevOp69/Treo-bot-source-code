...
module.exports = {   
  ...
  run: async (client, interaction, args) => {
        ...
        return interaction.followUp({
                content: `🔒 You do not have permission to use this command！${ad}`,
                ephemeral: true,
            });
        ...
        if (truefalse === true) {
            ...
            if (options === null)
                return interaction.followUp({
                    embeds: [
                        new MessageEmbed()
                            .setTitle(`${em.fail} | Please provide options`)
                            .setColor("RED"),
                    ],
                    ephemeral: true,
                });
            ...
            if (array.length > 10)
                return interaction.followUp({
                    embeds: [
                        new MessageEmbed()
                            .setTitle(`${em.fail} | up to 10 options`)
                            .setColor("RED"),
                    ],
                    ephemeral: true,
                });
...
let ad = ads.ad[Math.floor((Math.random() * ads.ad.length))];
        interaction.followUp({content: `${ad}`,
            embeds: [
                new MessageEmbed()
                    .setDescription(
