  ...
  DB.findOne({ Guild: guildId, MessageID: message.id },
    async (err, data) => {
      if (interaction.customId === 'sug-acc') {
        ...
        Embed.fields[2] = { name: "<:icons_yes:1018200822837952606> Status", value: "Accepted", inline: true }
      ...
      if (interaction.customId === 'sug-dec') {
        ...
        Embed.fields[2] = { name: "<:icons_no:1018202282657058866> Status", value: "Declined", inline: true }
      ...
      if (interaction.customId === 'sug-thr') {
        ...
        interaction.reply({ content: `${ad}\n${em.success} thread created`, ephemeral: true })
      }
