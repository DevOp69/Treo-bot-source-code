...
function onCoolDown(message, command) {
  ...
  const cooldownAmount = (command.cooldown) * 10000; //get the cooldownamount of the command, if there is no cooldown there will be automatically 1 sec cooldown, so you cannot spam it^^
